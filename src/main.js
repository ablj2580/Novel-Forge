...
import { wordCount, nowIso, uid, clamp } from './utils.js';
...
import { showToast, addLog, clearLogs, switchView, render, setSelectedNoteId, setSelectedModuleId, setSelectedChapterId, setReferenceModuleFilters, toggleReferenceFilter, setLogFilter, showModuleDialog, currentChapter, updateSearchUI, renderSearchSuggestions, hideSearchSuggestions } from './render.js';
